...
# #'
# #' @param master_all is tsv file with all mutations written out from somenone::variant_consensus(); colnames should be: "rowname", "Consequence", "IMPACT", "SYMBOL", "HGVSc", ""HGVSp", ""GVSp1", "CLIN_SIG", "samples_n",  "sampleIDs", "sample_1.AD", "sample_1.AD"1", " sample_1.AF", "sample_n.AD",  "sample_n.AD.1", "sample_n.AF", "sample_n.AD", "sample_n.AD"1", "sample_n.AF"
...
# #' @export
#
# make_pairtree_input <- function(master_all, cn_pattern, pp_pattern, which_genome, tag){
#
#   ##genome
...
#   master_tb <- readr::read_tsv(master_all)
